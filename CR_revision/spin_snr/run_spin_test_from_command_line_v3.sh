...
## pre: commands_for_matlab 
   #- trinarized maps
## post: spin results in /project/imco/baller/results/CR_revision/coupling_accuracy/spin_test_results/
...
wking_dir='/baller/scripts/CR_revision/spin_snr/'
command_file="$homedir/$wking_dir/commands_for_matlab_v3"
echo $command_file
